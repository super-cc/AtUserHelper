...
//        public static final String AT_PATTERN = "@\\(name:([^\\n\\r`~\\!@#\\$%\\^&\\*\\(\\)\\+=\\|'\\:;'\\,\\[\\]\\.\\<\\>/\\?！@#￥%……（）——\\{\\}【】‘；：”“’。，、？]+),id:([A-Za-z0-9]+)\\)";
    ...
    public static CharSequence parseAtUserLink(Context context, CharSequence text) {
        return parseAtUserLink(context, text, 0, false, null);
    }

    public static CharSequence parseAtUserLink(Context context, CharSequence text, int color) {
        return parseAtUserLink(context, text, color, false, null);
    }
     ...
     */
    public static CharSequence parseAtUserLink(Context context, CharSequence text, int color,
                                               boolean canClick, AtUserLinkOnClickListener clickListener) {
        ...
        while (matcher.find()) {
            ...
            if (color > 0) {
                AtUserForegroundColorSpan atUserLinkSpan = new AtUserForegroundColorSpan(context.getResources().getColor(color));
                ...
                spannableString.setSpan(new ClickableSpan() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (clickListener != null) {
                            ...
                            //跳到个人主页代码
//                            UserInfoFragment.show(context, atUserId);
                        }
                    }
...
//                    s.delete(start, end - 1);
     ...
     * 将User添加到At之后
     */
    public static void appendChooseUser(EditText editText, String name, String uid, TextWatcher watcher, int color) {
        if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(uid)) {
            ...
            editText.setText(parseAtUserLink(editText.getContext(), editText.getText(), color));
